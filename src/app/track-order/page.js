...
function OrderCard({ order, onClick }) {
  ...
  return (
    <div
      onClick={onClick}
      className="bg-white rounded-2xl p-5 border border-gray-100 cursor-pointer hover:border-[#B7FF1E] hover:shadow-md transition-all flex items-center gap-4"
    >
      {firstItem?.image && (
        <img
          src={firstItem.image}
...
function OrderDetail({ order, onBack }) {
  ...
  return (
    <div className="flex flex-col gap-5">
      <button
        onClick={onBack}
        className="flex items-center gap-2 text-sm font-semibold text-gray-500 hover:text-[#161616] transition-colors w-fit"
      >
        ← Back to Orders
      </button>
      ...
      <div className="bg-white rounded-3xl p-6 border border-gray-100">
        <div className="flex items-start justify-between mb-1">
          <h2 className="text-xl font-black text-[#161616]">
            Order #USS-{order.id.substring(0, 8).toUpperCase()}
          </h2>
          <span
            className="text-xs font-black px-3 py-1.5 rounded-full capitalize"
            style={{ background: sc.bg, color: sc.text }}
          >
            {order.status}
          </span>
      ...
      <div className="bg-white rounded-3xl p-6 border border-gray-100">
        <h3 className="font-black text-[#161616] mb-5">Delivery Progress</h3>
      ...
      <div className="grid grid-cols-2 gap-5">
        ...
        <div className="bg-white rounded-3xl p-5 border border-gray-100">
          <h3 className="font-black text-[#161616] mb-4">Order Summary</h3>
          <div className="flex flex-col gap-3">
      ...
      <div className="rounded-3xl p-6" style={{ background: '#F8F6F1' }}>
        ...
        <div className="flex gap-3">
          ...
          <a
            ...
            className="flex items-center gap-2 px-5 py-2.5 rounded-xl text-sm font-bold border border-gray-200 hover:border-gray-400 transition-all text-[#161616]"
          >
            📧 Email Us
          </a>
        </div>
...
function NotLoggedIn() {
  return (
    <div className="min-h-screen grid grid-cols-2" style={{ background: DARK }}>
      ...
      <div className="flex items-center justify-center px-12 py-16">
        <div className="bg-white rounded-3xl p-8 w-full max-w-md shadow-2xl">
          <h2 className="text-2xl font-black text-[#161616] mb-1">
          ...
          <div className="border-t border-gray-100 mt-6 pt-5 grid grid-cols-3 gap-3">
            {[
...
export default function TrackOrderPage() {
  ...
  return (
    <div className="min-h-screen pb-16" style={{ background: '#F7F8FA' }}>
      <div style={{ background: DARK }} className="px-16 py-10">
